def callback(path):
    def decorator(func):
        # TODO тут надо помещать в словарь app запись вида
        #    "ссылка": функция
...
# TODO Нужна не только эта строчка, но и определение пустронр словаря app (см. шаблон решения в задании) Это словарь
